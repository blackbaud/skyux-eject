...
export class AppModule { }`
  ...
  describe('add providers', () => {
    it('should add types to AppModule providers array', () => {
      const utils = mock.reRequire('../lib/utils/angular-utils');

      utils.addProviderToMainModule('', 'FooService', './foo.service');
...
providers: [
    ...
    it('should not add type if already exists', () => {
      defaultAppModuleContent = `@NgModule({
...
export class AppModule { }`;
    ...
    it('should handle existing providers section', () => {
      defaultAppModuleContent = `@NgModule({
  providers: []
})
export class AppModule {}`;
...
export class AppModule {}`
    ...
    it('should handle missing providers section when other sections exist', () => {
      defaultAppModuleContent = `@NgModule({
  imports: []
})
export class AppModule {}`;
