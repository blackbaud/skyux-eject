...
`;
  ...
  function getUtil() {
    return mock.reRequire('../lib/utils/eject/modify-karma-config');
  }

  it('should remove "karma-jasmine-html-reporter"', () => {
    const modifyKarmaConfig = getUtil();
    ...
    expect(fsExtraSpyObj.writeFileSync).toHaveBeenCalledWith(
      path.join('MOCK_EJECTED_PROJECT_PATH/projects/my-lib/karma.conf.js'),
